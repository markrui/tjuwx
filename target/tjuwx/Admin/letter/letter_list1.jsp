...
<html>
  <head>
    ...
    <table border="1" align="center" bordercolor="blue" width="50%" class="table table-hover">
        <tr>
        <div class="row">
            <th class="col-sm-1">信件编号</th>
            <th class="col-sm-2">收件人</th>
            <th class="col-sm-1">寄件人</th>
            <th class="col-sm-2">寄件地址</th>
    ...
    <s:iterator value="#session.letterlist" id="letter" status="st">
        <tr
            ...
            <td>
                <s:if test="#letter.status==1">
                    <a class="btn btn-primary btn-lg active"  href="sendletter.action?preAction=add&letter.lid=<s:property value='#letter.lid'/>">取走</a>
                </s:if>
                <s:else>
                    <a class="btn btn-primary btn-lg active"  href="backletter.action?preAction=search&letter.lid=<s:property value='#letter.lid'/>">放回</a>
                </s:else>
                <a class="btn btn-primary btn-lg active" href="deleteletter.action?preAction=search&letter.lid=<s:property value='#letter.lid'/>">删除</a>
            </td>
        </tr>
    </s:iterator>
